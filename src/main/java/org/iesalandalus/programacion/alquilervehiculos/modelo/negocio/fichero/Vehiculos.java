...
public abstract class Vehiculos implements IVehiculos {
    ...
    private Vehiculo getVehiculo(Element elementoVehiculo) throws OperationNotSupportedException {
        ...
        if (tipo.equalsIgnoreCase(TURISMO)) {
            ...
            return new Autobus(marca, modelo, matricula, Integer.parseInt(cilindrada), Integer.parseInt(plazas), Integer.parseInt(pma));
        } else if (tipo.equalsIgnoreCase(FURGONETA)) {
            return new Furgoneta(marca, modelo, matricula, Integer.parseInt(cilindrada), Integer.parseInt(plazas), Integer.parseInt(pma));
        } else {
